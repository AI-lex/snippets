...
# A: number of chars for each element / name
...
# A: create a subset of all names which contains 11 chars
...
# A: str() types of cols, dimension of data, few data displayed
# dim() only returns dim of dataframe
